...
--> statement-breakpoint
ALTER TABLE "climb_route" DROP CONSTRAINT "climb_route_created_by_users_id_fk";
--> statement-breakpoint
ALTER TABLE "climb_route" ADD COLUMN "createdBy" text NOT NULL;--> statement-breakpoint
...
ALTER TABLE "climb_route" DROP COLUMN "created_by";